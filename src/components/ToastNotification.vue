  ...
  <div v-if="visible" class="flex justify-center top-0 absolute mt-1 mx-auto w-full z-10">
    <div :id="styles.id"
      ...
      <div :class="`inline-flex items-center justify-center flex-shrink-0 w-8 h-8 ` + styles.classStyle">
        <svg v-if="styles.svg = 'success'" class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
        ...
        <svg v-else-if="styles.svg = 'failure'" class="w-5 h-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
          fill="currentColor" viewBox="0 0 20 20">
          <path
